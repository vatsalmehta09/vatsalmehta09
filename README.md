...
I'm an **AI/ML Engineer** based in Ahmedabad, India, building end-to-end intelligent systems — from fine-tuned LLMs and multi-RAG pipelines to production-grade ML APIs and AI agents. I care about taking AI from prototype to deployed, observable, and load-tested reality.

- 🤖 Building **LLM-powered applications** — RAG pipelines, AI agents, chatbots, prompt systems
...
- 🔗 Integrating **LangChain**, multi-agent frameworks, and API generation pipelines
